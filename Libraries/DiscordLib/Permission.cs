...
namespace DiscordLib
{
    ...
    {
        internal const Permissions FULL_PERMS = (Permissions)2147483647L;
        ...
        /// <returns></returns>
        public static bool HasPermission(this Permissions p, Permissions permission) { return (p & permission) == permission; }
        ...
        /// <returns></returns>
        public static Permissions Grant(this Permissions p, Permissions grant) { return p | grant; }
        ...
        /// <returns></returns>
        public static Permissions Revoke(this Permissions p, Permissions revoke) { return p & ~revoke; }
    }
